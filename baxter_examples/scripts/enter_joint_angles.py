...
def main():
    ...
    try:
        while True:
            joint_angle['left_s0'] = float(input("left_s0: "))
            joint_angle['left_s1'] = float(input('left_s1: '))
            joint_angle['left_e0'] = float(input('left_e0: '))
            joint_angle['left_e1'] = float(input('left_e1: '))
            joint_angle['left_w0'] = float(input('left_w0: '))
            joint_angle['left_w1'] = float(input('left_w1: '))
            joint_angle['left_w2'] = float(input('left_w2: '))

            pnp_left._guarded_move_to_joint_position(joint_angle)

            joint_angle['right_s0'] = float(input("right_s0: "))
            joint_angle['right_s1'] = float(input('right_s1: '))
            joint_angle['right_e0'] = float(input('right_e0: '))
            joint_angle['right_e1'] = float(input('right_e1: '))
            joint_angle['right_w0'] = float(input('right_w0: '))
            joint_angle['right_w1'] = float(input('right_w1: '))
            joint_angle['right_w2'] = float(input('right_w2: '))
            pnp_right._guarded_move_to_joint_position(joint_angle)

            print(pnp_left.get_tf_start_to_end_frames())
